...
static int parse_next_number(char *input, int *i) {
  int j = *i;
...
static void parse_line(char *input, int *i, int j) {
...
static void iter_shares(unsigned int elements, unsigned int total, unsigned int *share, size_t i, void(*fun)(unsigned int*, void*), void *args) {
  if (elements > total) {
...
static unsigned int calc_share_value(unsigned int *share) {
...
static unsigned int calc_share_value_if_500cal(unsigned int *share) {
...
static void find_max_share(unsigned int *share, void *args) {
...
static void find_max_share_500cal(unsigned int *share, void *args) {
  unsigned int *max_ptr = args;
  unsigned int max = *max_ptr;
