...
__attribute__((pure)) static int list_cmp(const struct list *left, const struct list *right) {
...
static int int_cmp(int left, int right) { return left - right; }
...
__attribute__((pure)) static int list_cmp_wrp(const void *a, const void *b) { return list_cmp(a, b); }
