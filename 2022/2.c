...
static int score_round_1(int opponent, int self) { return score_shape[self] + score_outcome[rps[self][opponent]]; }

static int score_round_2(int opponent, int self) { return score_shape[invrps[self][opponent]] + score_outcome[self]; }
...
static void solution1(const char *input, char *const output) { solution(input, output, score_round_1); }

static void solution2(const char *const input, char *const output) { solution(input, output, score_round_2); }
