...
static int namecmp(const void *p1, const void *p2) { return strncmp(p1, p2, 3); }
...
static void neighbor_list_free(struct neighbor_list *list) { free(list->neighbors); }
...
static int adjacency_list_count_neighbors(const struct adjacency_list *list, int n) { return list->nodes[n].len; }
