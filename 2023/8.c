...
static void sort_nodes(struct node *nodes, int nnodes) {
	qsort(nodes, nnodes, sizeof(*nodes), node_cmp);
}
...
static void parse_input(const char *input, const char **directions, int *ndirections, struct node **nodes, int *nnodes) {
