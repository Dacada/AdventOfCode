...
static void module_collection_add_broadcaster_connections(struct module_collection *collection, int *connections,
                                                          int nconnections) {
  collection->nconnections_broadcaster = nconnections;
  collection->connections_broadcaster = connections;
}

static void module_collection_add_module(struct module_collection *collection, struct module *module, int *connections,
                                         int nconnections) {
