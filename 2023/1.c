...
static void parse_line(const char **input, int *first, int *last, int (*parse_number)(const char **)) {
...
static int parse_input(const char *input, int **numbers, int (*parse_number)(const char **)) {
  int size = 0;
  int capacity = 16;
...
static void solution(const char *const input, char *const output, int (*parse_number)(const char **)) {
  int *numbers;
...
static void solution1(const char *const input, char *const output) { solution(input, output, parse_number_1); }

static void solution2(const char *const input, char *const output) { solution(input, output, parse_number_2); }
