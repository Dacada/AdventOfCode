...
static int count_safe_bricks(const struct state *state) { return count_bricks(state, true); }
...
static int count_unsafe_bricks(const struct state *state) { return count_bricks(state, false); }
