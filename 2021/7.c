...
static unsigned calc_diff(const unsigned *const nums, const size_t len, const unsigned num, unsigned(*move_cost)(unsigned, unsigned)) {
        unsigned diff = 0;
        for (size_t i=0; i<len; i++) {
...
static void solution1(const char *const input, char *const output) {
        solution(input, output, get_move_cost_1);
}

static void solution2(const char *const input, char *const output) {
        solution(input, output, get_move_cost_2);
}
