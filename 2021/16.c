...
static unsigned extract_bits(const char **const hex, unsigned *const reserve, unsigned *const reserve_len, unsigned count) {
...
static struct literalPacket *parse_literalPacket(const char **const input, unsigned *const bits, unsigned *const nbits, unsigned *const bitsConsumed) {
...
static struct operationPacket *parse_operationPacket(const char **const input, unsigned *const bits, unsigned *const nbits, unsigned *const bitsConsumed) {
...
static struct packet *parse_packet(const char **const input, unsigned *const bits, unsigned *const nbits, unsigned *const bitsConsumed) {
