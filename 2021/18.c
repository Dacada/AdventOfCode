...
__attribute__((pure)) static struct number *find_explode(struct number *const number, unsigned current_depth) {
...
__attribute__((pure)) static struct number *find_left_from(struct number *const number) {
  find_x_from(number, x, y, find_left_from);
}

__attribute__((pure)) static struct number *find_right_from(struct number *const number) {
...
__attribute__((pure)) static struct number *find_split(struct number *const number) {
  if (number->leaf) {
...
__attribute__((pure)) static unsigned magnitude(const struct number *const number) {
  if (number->leaf) {
