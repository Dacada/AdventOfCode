...
enum instr { INSTR_RECT, INSTR_ROT_ROW, INSTR_ROT_COL, INSTR_LAST };
...
static inline bool screen_get(const unsigned x, const unsigned y) { return screen[y * WIDTH + x]; }
static inline void screen_set(const unsigned x, const unsigned y, const bool val) { screen[y * WIDTH + x] = val; }
