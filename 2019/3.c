...
static int manhattan_distance(struct vec2 p1, struct vec2 p2) {
...
static bool line_segments_intersect(const struct segment *const line1,
                                    const struct segment *const line2,
