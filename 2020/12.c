...
enum direction { north, east, south, west, left, right, forward };
...
__attribute__((pure)) static struct position rotate_rel(struct position relpos, enum direction rotation,
