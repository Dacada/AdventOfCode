...
static void init_bag(struct bag *const bag, const char *color) {
...
__attribute__((nonnull (1)))
static void free_bag(struct bag *const bag) {
        free(bag->parents);
        free(bag->children);
...
__attribute__((nonnull (1, 2)))
static void add_child_to_bag(struct bag *const parent, struct bag *const child, const unsigned amount) {
...
__attribute__((nonnull (1)))
static void stack_init(struct stack *const stack, size_t capacity) {
...
__attribute__((nonnull (1)))
static void stack_push(struct stack *const stack, const struct bag *element) {
        stack->top++;
...
__attribute__((nonnull (1)))
static const struct bag *stack_pop(struct stack *const stack) {
...
__attribute__((nonnull (1)))
static void stack_free(struct stack *const stack) {
        free(stack->elements);
        stack->elements = NULL;
...
__attribute__((nonnull (1)))
static void add_bag_color(const char *const color) {
...
__attribute__((nonnull (1)))
static struct bag *color_to_bag(const char *const color) {
        if (bags == NULL) {
                return NULL;
        }
...
__attribute__((nonnull (1, 2)))
static void parse_skip(const char *const expected, const char **input) {
...
__attribute__((nonnull (1, 2)))
static void parse_color(char *buff, const char **input) {
...
__attribute__((nonnull (1)))
static void parse_line_pass(const char **input, const int pass) {
...
__attribute__((nonnull (1)))
static void parse_pass(const char *input, const int pass) {
        for (; *input!='\0'; input++) {
...
__attribute__((nonnull (1)))
static unsigned count_total_bags(struct bag *const bag) {
